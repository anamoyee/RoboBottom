...
TOKEN = tcrd.get_token('TOKEN.txt', depth=3)  # 3-1 = 2 counting src/
UPTIME = tcr.Uptime()
VERSION = S.MAJOR_VERSION_TEMPLATE % (p.Path(__file__).parent.parent / 'VERSION.txt').read_text().strip()
...
# TODO: move those settings ones to a UserSettings class or sth
